...
def parser():
    ...
    parser.add_argument('--affix', default='ACE_long_new', help='the affix for the save folder')
...
#         help='movement multiplier per iteration when generating adversarial examples (2/255=0.00784)')
    ...
    parser.add_argument('--alpha', '-a', type=float, default=0.1, 
        help='step size for updating the filter parameters in each iteration')
    parser.add_argument('--steps', '-s', type=float, default=64, 
        help='the numeber of pieces in ACE')
    ...
    parser.add_argument('--n_eval_step', type=int, default=400, 
